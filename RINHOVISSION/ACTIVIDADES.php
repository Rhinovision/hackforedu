...
<head>
    ...
    display: grid;
    grid-template-columns: 250px 1fr; /* Define dos columnas, una para la barra lateral y otra para el contenido principal */
    grid-template-rows: 100vh; /* Establece la altura de la página a 100vh */
}
...
@media (max-width: 768px) {
    body {
        grid-template-columns: 1fr; /* En pantallas pequeñas, la barra lateral se apila sobre el contenido */
    }

    .sidebar {
        width: 100%;
        height: auto; /* La altura será automática para adaptarse al contenido */
    }

    .main-content {
        margin: 0; /* Sin margen en la parte izquierda en dispositivos pequeños */
    }
}

...
<head>
    ...
    min-height: 100vh; /* Asegura que el cuerpo ocupe al menos el alto completo de la ventana */
}
...
.sidebar {
    ...
    overflow-y: auto; /* Permite desplazamiento si el contenido excede el alto de la pantalla */
}
...
.main-content {
    ...
    min-height: 100vh; /* Asegura que el contenido ocupe al menos el alto completo de la ventana */
    color: white;

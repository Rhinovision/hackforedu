...
<head>
    ...
    <style>
        ...
        .main-content {
            margin-left: 270px;
            /* Ajusta este margen si cambias el ancho de la barra lateral */
            padding: 40px;
            background-color: #333;
            min-height: 100vh;
            /* Asegúrate de que el contenido mínimo sea 100vh */
            color: white;
            flex: 1;
            /* Permite que el contenido principal ocupe el espacio restante */
            transition: margin-left 0.3s;
            /* Transición suave en el margen */
        }
        ...
        @media (max-width: 768px) {
            ...
            .main-content {
                margin-left: 220px;
                /* Ajusta el margen para que se vea bien */
                padding: 20px;
                /* Reduce el padding en el contenido principal */
            }
            ...
            .profile-pic {
                width: 150px;
                /* Reduce el tamaño de la imagen de perfil */
                height: 150px;
                /* Ajusta también la altura */
            }

            .profile-info {
                max-width: 300px;
                /* Ajusta el ancho máximo de la info del perfil */
            }
        }
        ...
        @media (max-width: 576px) {
            .sidebar {
                width: 150px;
                /* Ancho aún más reducido para pantallas pequeñas */
            }
            ...
            .profile-pic {
                ...
                height: 120px;
                /* Ajusta la altura también */
            }

            .profile-info {
                max-width: 100%;
                /* Asegúrate de que la info del perfil use el 100% */
            }
        }
    </style>
</head>
